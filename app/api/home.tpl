	...
	<div class=inner>
		<div class=cell>
			<div class=settingbox>
                ...
                <div class="standalonebutton"><button class="ui-light-btn channel" url="/index.php/ft/channel/phonetemplate.html?channel=myftsetup">设���我的<font class=english>FT</font></button></div>                                
